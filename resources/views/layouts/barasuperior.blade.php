<header class="header white-bg">
            ...
            <!--logo start-->
            <a href="{{ route('dashboard') }}" class="logo">{{ env('APP_PRIMARY_NAME') }}<span>{{ env('APP_SECONDARY_NAME') }}</span></a>
            <!--logo end-->
            ...
            <div class="top-nav ">
                ...
                <ul class="nav pull-right top-menu">
                    ...
                    <li class="dropdown">
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <img style="max-width: 32px; min-width: 32px; width: 32px;" alt="{{ Auth::user()->name }}" src="{{ Auth::user()->fotoperfil ?? asset('img/foto/default.jpg') }}">
                            <span class="username">{{ Auth::user()->name }}&nbsp;{{ Auth::user()->familiname }}</span>
                            <b class="caret"></b>
                        </a>
                        <ul class="dropdown-menu extended logout dropdown-menu-right">
                            <div class="log-arrow-up"></div>
                            <li><a href="{{ route('Perfil') }}"><i class=" fa fa-suitcase"></i>Perfil</a></li>
                            <li><a href="#"><i class="fa fa-cog"></i> Configurações</a></li>
                            <li><a href="#"><i class="fa fa-bell-o"></i> Notificações</a></li>
                            <li><a href="{{ route('logout') }}"><i class="fa fa-key"></i> Sair</a></li>
                        </ul>
                    </li>
