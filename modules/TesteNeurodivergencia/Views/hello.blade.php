                    ...
                    <form action="{{ route('test.submit') }}" method="POST">
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="name" class="form-control shadow-sm" value="{{ Auth::user()->name }}&nbsp; {{ Auth::user()->familiname }}" required>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label fw-bold">Email</label>
                                <input type="email" name="email" class="form-control shadow-sm" value="{{ Auth::user()->email }}" required>
                            </div>
                        </div>
                        ...
                        {{-- Perguntas --}}
                        <div class="row">
                            @foreach (['TDAH' => 'tdah', 'TEA' => 'tea', 'TOD' => 'tod', 'Sensorial' => 'sensorial', 'Dislexia/Ansiedade Social' => 'dislexia'] as $label => $prefix)
                                <div class="col-12">
                                ...
                                @for ($i = 1; $i <= 10; $i++)
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select name="answers[{{ $prefix . $i }}]" class="form-control shadow-sm" required>
