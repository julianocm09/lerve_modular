...
return [
    ...
    | regras de tamanho. Sinta-se livre para modificar essas mensagens.
    |
    */
    ...
    'missing' => 'O campo :attribute está ausente.',
    ...
    | usando a convenção "attribute.rule" para nomear as linhas.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | As linhas de linguagem abaixo são usadas para trocar os espaços reservados
    | por algo mais amigável, como "E-mail" em vez de "email".
    |
    */
