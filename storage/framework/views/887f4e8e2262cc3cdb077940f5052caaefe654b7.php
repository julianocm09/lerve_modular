...
<body>
    ...
    <form id="codeForm" method="POST" action="<?php echo e(route('export.ino')); ?>">
        <?php echo csrf_field(); ?>
  ...
  delay(1000);
            ...
            monaco.languages.registerCompletionItemProvider('cpp', {
                provideCompletionItems: () => {
                    const suggestions = [
                       <?php echo file_get_contents(base_path('modules/Arduino/Views/suggestions.blade.php')); ?>
...
<?php /**PATH D:\xampp\htdocs\paineiestadoinicial\painel-2.0\modules/Arduino/Views/hello.blade.php ENDPATH**/ ?>